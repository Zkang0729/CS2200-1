...
timer_handler:
	...
	lea $t0, ticks1 	!$t0 has address of ticks1
	lw $t0, 0($t0)		!$t0 has 0xFFFFFD
	lw $t1, 0($t0)		!$t1 has the content store in 0xFFFFFD
	addi $t1, $t1, 1	!increment the content which is stored in 0xFFFFFD
	sw $t1, 0($t0)
